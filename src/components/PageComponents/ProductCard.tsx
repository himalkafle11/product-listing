  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2">
        <div className="text-sm font-semibold rounded-md px-2 py-1 border border-secondaryColor">
          {product.offPercent} % off
        </div>{" "}
        <div className="border border-primaryColor text-sm font-semibold rounded-md px-2 py-1">
